          ...
          <div className="flex flex-col h-fit">
            ...
            <div className="py-2 border-b border-gray-200">
              <div className="py-4 flex items-center gap-4">
                <VscVerifiedFilled size={60} />
                <div>
                  <h2 className="text-md mb-1 font-medium">Stat Header</h2>
                  <p className="text-gray-500 text-sm">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ab
                    et quia deserunt aliquam debitis dolore, ipsa sit optio,
                    nulla, suscipit ad temporibus voluptates sint aperiam
                    consequuntur. Facilis sed corrupti et?
                  </p>
                </div>
              </div>
              <div className="py-4 flex items-center gap-4">
